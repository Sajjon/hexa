...
import { View, Text, StyleSheet, Linking, FlatList, Image, SafeAreaView, ImageSourcePropType, Platform } from 'react-native'
...
const EditContactScreen: React.FC<Props> = ( { navigation, }: Props ) => {
  ...
  const menuOptions: MenuOption[] = [
    {
      title: 'Edit Name',
      imageSource: require( '../../assets/images/icons/contact_name.png' ),
      subtitle: 'Show all account on the Home Screen',
      screenName: 'AccountManagement',
    },
    {
      title: 'Associate a Contact',
      imageSource: require( '../../assets/images/icons/phonebook.png' ),
      subtitle: 'Connect Hexa wallet to your own Bitcoin node',
      screenName: 'NodeSettings',
      onOptionPressed: () => {
        setIsLoadContacts( true )
